...
FUNCIONES
Cada oración cumple una de estas funciones:
- DATO: un hecho que se presenta como evidencia.
- CONCLUSIÓN: una afirmación que se defiende apoyándose en otras.
- GARANTÍA: una regla general que autoriza pasar de un dato a una conclusión.
- RESPALDO: evidencia de alcance general que sostiene una regla general.
...
No son elementos aparte. Si una conclusión trae palabras que marcan la fuerza con que se afirma, cópialas literalmente en su campo "cualificador". Si trae, dentro de la misma oración, una condición de la que depende, copia esa parte literalmente en su campo "reserva". Si no, deja esos campos vacíos.
...
6. La tesis dice qué sostiene `texto`, no por qué. No incluyas sus razones.
7. En "cercana_a", pon el id de la conclusión cuyo sentido más se parece a tu tesis, o null si ninguna se parece.
8. En "proposito", di en una oración qué busca el autor de `texto`.
