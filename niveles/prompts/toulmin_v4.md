...
- DATO: un hecho del caso que el texto presenta como evidencia.
...
- GARANTÍA: una regla general que el texto aplica al caso.
  Ej.: "El agua que supera el límite de arsénico no es apta para el consumo."
- RESPALDO: evidencia general sobre una clase de casos: un estudio, una norma, la experiencia acumulada.
...
CASO Y CLASE DE CASOS (para separar DATO de RESPALDO)
- Un DATO habla del caso que el texto discute (este lugar, estas personas, este periodo), aunque venga de una fuente.
- Un RESPALDO habla de la clase de casos en general (estudios, normas o experiencia sobre casos como este).

TIPO DE APOYO (para separar CONCLUSIÓN de GARANTÍA)
No te fijes en si la frase es general o particular; fíjate en qué la apoya:
- si el texto la apoya con datos del caso, es CONCLUSIÓN, aunque esté dicha en términos generales;
- si el texto la aplica al caso sin probarla con datos del caso, sola o con un respaldo, es GARANTÍA.
