"""Corrida: misma escena, juicios sobre que es la frase de Juan (con ironia), 3 replicas.

Body fijo (verbatim, no se toca). Crudos en
cache/modalidad-escena-3-r{1,2,3}.json. Idempotente: si el crudo de una
...
BODY = {
    ...
    "questions": {
        "q1": {
            ...
            "instructions": "",
            "criteria": {
                "a": "La frase de Juan es un pedido",
                "b": "La frase de Juan es una pregunta",
                "c": "La frase de Juan es una afirmación",
                "d": "La frase de Juan es una queja",
                "e": "La frase de Juan es una ironía",
                "f": "La frase de Juan es otra cosa",
            },
        }
    },
}
...
def cache_path(rep):
    return os.path.join(CACHE_DIR, f"modalidad-escena-3-r{rep}.json")
