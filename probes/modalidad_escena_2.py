"""Corrida: misma escena, juicios sobre lo que hace Juan (no sobre la forma), 3 replicas.

Body fijo (verbatim, no se toca). Crudos en
cache/modalidad-escena-2-r{1,2,3}.json. Idempotente: si el crudo de una
...
BODY = {
    ...
    "questions": {
        "q1": {
            ...
            "instructions": "",
            "criteria": {
                "a": "Juan le pide a su esposa que abra las ventanas",
                "b": "Juan le pregunta a su esposa si hace frío",
                "c": "Juan afirma que hace frío",
                "d": "Juan se queja del calor",
                "e": "Juan hace otra cosa",
            },
        }
    },
}
...
def cache_path(rep):
    return os.path.join(CACHE_DIR, f"modalidad-escena-2-r{rep}.json")
