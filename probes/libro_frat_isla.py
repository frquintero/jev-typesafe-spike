"""Frat e isla de los durmientes (hecho ficticio sin titular notorio): state como string (sin clave), juicio "El libro antiguo dice que...". 3 réplicas.
Crudos: cache/libro-frat-isla-r{1..3}.json
"""
...
body = {"model": MODEL,
        ...
        "questions": {
            "libro_dice": {"type": "noul", "instructions": "El libro antiguo dice que Frat encontró la isla de los durmientes."}}}
for rep in (1, 2, 3):
    path = os.path.join(CACHE_DIR, f"libro-frat-isla-r{rep}.json")
