"""Spike: Noul — párrafo EN en el state, afirmación 'tiene más de 20 letras'."""
import json
import os
...
body = {
    ...
    "questions": {
        "n01": {
            "type": "noul",
            "instructions": "tiene más de 20 letras",
        }
    },
}
...
with open("spike-jev/cache/parrafo-noul-20.json", "w") as f:
