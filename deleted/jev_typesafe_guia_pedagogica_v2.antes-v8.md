...
> Versión 7 — 23 de septiembre de 2026
...
- **Que `instructions` y los juicios de `criteria` no se contradigan** (límite 7).
...
7. **Juicio y criterios contradictorios**: si `instructions` y `criteria` chocan, o los juicios de `criteria` son ambiguos o incompatibles, Jev puede confundirse.
