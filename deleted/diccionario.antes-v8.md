...
veredicto. Es una precaución barata. (Una medición anterior con la
clave `falso` quedó retirada: solo existe el crudo de un extremo,
`noul-falso2.json`.)
...
- Diciendo exactamente lo que quieres: las palabras de alcance, las
  ...
  (límite 1). «¿Tiene **alguna** experiencia en Python?» no deja
  término medio.
